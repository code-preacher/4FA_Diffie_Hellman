            ...
            <div class="auth-box bg-light border-top border-secondary">
                <div id="loginform"><?php $lib->msg();?>
                    <div class="text-center p-t-20 p-b-20">
                        <span style="color: #000;font-size: 18px;">DIFFIE-HELLMAN ALGORITHM</span><br>
                        <h4>ADMIN LOGIN</h4>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="admin-login.php" method="post">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
<!--                                        <button class="btn btn-info" type="button" onclick="window.location.href='register.php'"-->
<!--                                        ><i class="fa fa-lock m-r-5"></i> Create a new account</button>-->
                                        <button class="btn btn-success float-right" type="submit" name="sub">Login</button>
                                    </div>
                                </div>
